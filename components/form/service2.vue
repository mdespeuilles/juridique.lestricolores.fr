<template>
  <section>
    ...
    <div class="offres">
      <div>
        <div class="img">
          <img src="/img/facturation.svg" />
        </div>

        <strong>Logiciel de facturation</strong>
      </div>

      <div>
        <div class="img">
          <img src="/img/note-de-frais.svg" />
        </div>

        <strong>Gestion des notes de frais</strong>
      </div>
      ...
      <div>
        ...
        <strong>Déclaration de TVA</strong>
      </div>
    </div>
