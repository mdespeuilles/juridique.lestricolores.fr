<template>
  <div>
    ...
    <h1>L'ASSEMBLEE GENERALE ORDINAIRE DE NOMINATION DU PRÉSIDENT</h1>

    <h2>Première résolution :</h2>

    <p>Est nommé aux fonctions de président telles que définies par la loi et les statuts de la société, à compter de ce jour et pour une durée indéterminée :</p>
    ...
    <p>La rémunération du président sera fixée ultérieurement.</p>
    <p>
      <strong>Résolution adoptée à l’unanimité</strong>
    </p>
    ...
    <div v-if="submission.directeurGeneral">
      <div v-if="submission.directeurGeneral.nom">
        ...
        <p>Est nommé aux fonctions de directeur général telles que définies par la loi et les statuts de la société, à compter de ce jour et pour une durée indéterminée :</p>
        <p>
        ...
        <p>La rémunération du directeur général sera fixée ultérieurement.</p>
        <p>
          <strong>Résolution adoptée à l’unanimité</strong>
        </p>
      </div>
