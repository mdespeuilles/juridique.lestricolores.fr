<template>
  <div>
    ...
    <p>
      Les associés approuvent les comptes de clôture de liquidation et constate
      ce jour la clôture de la liquidation. Ceux-ci mentionnent un solde de
      liquidation de {{ submission.soldeLiquidation|currency }}.
    </p>
    <p>
      <strong>
    ...
    <p>
      Les associés déchargent <people :people="submission.liquidateur" :short="true" /> de sa mission de liquidateur.
      Quitus entier lui en est donné.
    </p>
    <p>
      <strong>
        Cette résolution, mise aux voix, est adoptée à l’unanimité.
